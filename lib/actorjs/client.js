(function () {
    ...
    /**
     * Client which connects with an ActorJS client in an IFRAME, using JSON-RPC and publish-subscribe messaging via the HTML Cross-Domain Messaging API.
     *
     * @param cfg
     * @param {String} cfg.iframe ID of an IFRAME containing an actorJS server page
     */
    window.ActorJSClient = function (cfg) {
